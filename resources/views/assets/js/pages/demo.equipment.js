$(document).ready(function () {
  ...
  $("#products-datatable").DataTable({
    language: {
      ...
      info: "Mostrando Equipamentos _START_ to _END_ of _TOTAL_",
      lengthMenu:
        'Mostrar <select class=\'form-select form-select-sm ms-1 me-1\'><option value="5">5</option><option value="10">10</option><option value="20">20</option><option value="-1">All</option></select> Equipamentos',
    },
    pageLength: 5,
    columns: [
      {
