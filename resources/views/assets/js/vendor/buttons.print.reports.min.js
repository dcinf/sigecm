      ...
      if (c) {
        ...
        var customHeaderHTML = `
          ...
          <div class="custom-header">
            <img src="resources/views/assets/images/emblema.png" alt="Logo">
            <h4>Presidencia da Republica</h4>
            <p>Casa Militar</p>
          </div>
        `;

        // Adicionando o Footer com "Processado por computador" e a data
        var footerHTML = `
          <div class="footer">
            Processado por computador - ${new Date().toLocaleDateString()} ${new Date().toLocaleTimeString()}
          </div>
        `;

        c.document.body.innerHTML =
          customHeaderHTML + "<h3>" + 'Relatorio de Entradas e Saidas de visitantes' + "</h><div>" +
          (p.messageTop || "") +
          "</div>" + m + "<div>" + (p.messageBottom || "") + "</div>" + footerHTML;
