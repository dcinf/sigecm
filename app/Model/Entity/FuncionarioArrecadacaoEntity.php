<?php
    ...
    class FuncionarioArrecadacaoEntity{
        ...
        public  function cadastrar(){
            $this->codigo_funcionario = (new Database('funcionarios_armamento'))->insert([
        ...
        public static function getFuncionario($where = null, $order = null, $limit = null, $fields = "*"){
            return (new Database('funcionarios_armamento'))->select($where, $order, $limit, $fields);
        }
        ...
        public  function actualizar(){
            return (new Database('funcionarios_armamento'))->update('codigo_funcionario = '.$this->codigo_funcionario, [
                'nome_completo'             => $this->nome_completo,
                'subunidade'                => $this->subunidade,
                'genero'                    => $this->genero,
                'patente'                   => $this->patente,
